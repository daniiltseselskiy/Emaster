			...
			<Navbar className="header">
				...
				<Navbar.Collapse>
					<Nav pullRight>
						...
						<NavItem target="_blank"  href="https://www.instagram.com/emasters.co/"><img src={tw} alt="" className="social"/></NavItem>
						<NavItem  target="_blank" href="https://twitter.com/eMastersco"><img src={insta} alt="" className="social"/></NavItem>
